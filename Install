...
END
	...
	wget -O /usr/local/bin/menu "https://raw.githubusercontent.com/Third10/nonstop/master/menu"
...
wget -O /usr/local/bin/install "https://raw.githubusercontent.com/banklovelo01/Third10/master/Install.sh" && chmod +x /usr/local/bin/install && install
